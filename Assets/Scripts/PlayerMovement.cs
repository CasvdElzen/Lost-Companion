...
public class PlayerMovement : MonoBehaviour
{
	...
	private void Update()
	{
		...
		{
			GameObject obj = Instantiate(DashEffect, transform.position - (Vector3.up * transform.localScale.y / 2), Quaternion.Euler(-90, 0, 0));
			Destroy(obj, 1);
			Dash.Play();
			
			FindObjectOfType<RippleEffect>().Emit(Camera.main.WorldToViewportPoint(transform.position));
			//CinamachineShake.Instance.ShakeCamera( 0.1f, 0f);
